...
urlpatterns = [
    ...
    path('books/<int:pk>/bulk-edit/', views.book_bulk_edit, name='book-bulk-edit'),
    path('books/<int:pk>/bulk-edit/form/', views.book_bulk_edit_form, name='book-bulk-edit-form'),
